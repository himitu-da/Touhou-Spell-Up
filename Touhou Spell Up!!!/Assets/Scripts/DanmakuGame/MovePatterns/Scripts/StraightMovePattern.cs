...
[CreateAssetMenu(fileName = "StraightMovePattern", menuName = "Touhou Spell Up/Move Pattern/Straight")]
public class StraightMovePattern : MovePatternBase
{
    ...
    public override async UniTask ExecuteImpl(Mover mover, CancellationToken token)
    {
